{{{include front/layout/breadcrumb.layout}}}
  ...
  <section class="content clearfix">
    ...
    <div class="pro_con clearfix">
      <a href="{{# URL::base_path()}}/{{# $categorySlug }}/{{# $companySlug }}/{{# isset($vProduct['name']) ? StringLib::convertUrl($vProduct['name']) : null }}-prd{{# $vProduct['id'] }}.html">
        ...
        {{endif}}
          ...
          <!-- <div class="mask">
            <div class="mask-title">
              <div class="icon"></div>
              <div class="text">TaoDoc Care</div>
            </div>
            <ul class="mask-list">
      ...
      <div class="thongtin_pro clearfix">
        <div class="thongtin_pro_left clearfix">
          <p class="name_pro"><a href="{{# URL::base_path()}}/{{# $categorySlug }}/{{# $companySlug }}/{{# isset($vProduct['name']) ? StringLib::convertUrl($vProduct['name']) : null }}-prd{{# $vProduct['id'] }}.html">{{# isset($vProduct['name']) ? $vProduct['name'] : 'N/A'}}</a></p>
        ...
        <div class="thongtin_pro_right clearfix">
          ...
          <a href="{{# URL::base_path()}}/{{# $categorySlug }}/{{# $companySlug }}/{{# isset($vProduct['name']) ? StringLib::convertUrl($vProduct['name']) : null }}-prd{{# $vProduct['id'] }}.html" class="btn_mua">Mua</a>
        </div>
      </div>
    </div>
    {{endforeach}} {{endif}}
