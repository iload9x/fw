    ...
    <div class="loader"><div class="loader-spin"></div></div>
      <div class="panel-heading">
        <div class="panel-tools">
	        ...
	        <a href="{{# URL::base_path('/admin/cart/types/add')}}" style="text-decoration: none;border: #1bbf89 1px solid;color: #fff;padding: 4px 6px;">Thêm <i class="fa fa-plus"></i></a>
		  ...
		  <table class="table table-bordered">
		    ...
		    {{if(isset($dsCategory)):}}
			    ...
			    {{foreach($dsCategory as $v):}}
			      <tr>
			        <th scope="row">{{# $id}}</th>
			        <td><a href="{{# URL::base_path('/admin/cart/types/edit?id='.$v['id'])}}">{{# isset($v['name']) ? $v['name'] : 'N/A'}}</a></td>
