						...
						<form action="" method="POST" enctype="multipart/form-data">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select class="form-control select2_demo_2" name="categoryId">
										{{if(isset($dsCategory)):}}
								...
								<div class="form-group">
									...
									<select class="form-control select2_demo_2" name="companyId">
										{{if(isset($dsCompany)):}}
										{{foreach($dsCompany as $v):}}
										<option value="{{# $v['id']}}">{{# $v['name']}}</option>
										{{endforeach}}
										{{endif}}
									</select>
								...
								<div class="form-group">
									...
									<select class="form-control select2_demo_2" name="typeId">
										{{if(isset($dsType)):}}
										{{foreach($dsType as $v):}}
										<option value="{{# $v['id']}}">{{# $v['name']}}</option>
										{{endforeach}}
