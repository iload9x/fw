    ...
    $('.signup-button').on('click',function(){
        ...
        if(email == '') {
            ...
            loadAjax(
                ...
                {
                    beforeSend:function(){
                        $('#ajaxsignup').append('<img class="loading" src="/themes/img/loading.gif"/>');
    ...
    $('.login-button').on('click',function(){
        ...
        if(email == '') {
            ...
            loadAjax(
                ...
                {
                    beforeSend:function(){
                        $('#ajaxlogin').append('<img class="loading" src="/themes/img/loading.gif"/>');
    ...
    $('#subscribe-btn').click(function(){
        ...
        if(email == '') {
            ...
            loadAjax(
                ...
                {
                    beforeSend:function(){
                        $('#subscribe-form').append('<img class="loading" src="/themes/img/loading.gif"/>');
