...
$(function () {
    ...
    $(".next-banner-slide").click(function () {
        owl.trigger('owl.next');
    })
    $(".prev-banner-slide").click(function () {
        owl.trigger('owl.prev');
    })

    var owl = $("#banner-slidepr");
    ...
    // Custom Navigation Events
    $(".next-banner-slidepr").click(function () {
        owl.trigger('owl.next');
    })
    $(".prev-banner-slidepr").click(function () {
        owl.trigger('owl.prev');
    })

    var owl = $("#title-accessories");
    ...
    var owl = $("#index-content-title");
    var owl2 = $("#index-content-title-2");
    ...
    //$(".next-index-content-title").click(function () {
    //    owl.trigger('owl.next');
    //})
    //$(".prev-index-content-title").click(function () {
    //    owl.trigger('owl.prev');
    //})
    //$(".next-index-content-title-2").click(function () {
    //    owl2.trigger('owl.next');
    //})
    //$(".prev-index-content-title-2").click(function () {
    //    owl2.trigger('owl.prev');
    //})

    var owl = $("#title-guarantee");
    ...
    // Custom Navigation Events
    //$(".next-guarantee").click(function () {
    //    owl.trigger('owl.next');
    //})
    //$(".prev-guarantee").click(function () {
    //    owl.trigger('owl.prev');
    //})


    $(".specifications-see-more").click(function () {
        $(".list-specifications-none").toggle(500);
    });

    $("#opinion-slide").owlCarousel({
    ...
    // Custom Navigation Events
    //$(".next-banner-product-main").click(function () {
    //    owl.trigger('owl.next');
    //})
    //$(".prev-banner-product-main").click(function () {
    //    owl.trigger('owl.prev');
    //})

});

function add_cart(ProductID, ColorID, ReturnPath) {
    location.href = '/gio-hang/Add.html?ProductID=' + ProductID + '&ColorID=' + ColorID + '&Quantity=1&returnpath=' + ReturnPath;
}
