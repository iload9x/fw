...
<!-- Mirrored from webapplayers.com/luna_admin-v1.3/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Apr 2017 15:41:05 GMT -->
<head>
    <meta charset="utf-8">
...
<section class="content">
  ...
  <div class="container-center md animated slideInDown">
    ...
    <div>
      <a href="<?php echo URL::oldUrl() ?>" class="btn btn-accent">Back to app</a>
    </div>
